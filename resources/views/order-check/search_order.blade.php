...
@section('content')
<form method="get" action="{{url('get-info-order')}}" class="search-order__body row">
    <div class="col"></div>
    <div class="col-lg-5 search-order__container">
        <div class="search-order__title">Tra cứu đơn hàng theo thông tin</div>
        ...
        <div class="row search-order__section">
            <div class="col-3 search-order__section--title">Mã đơn hàng *</div> 
            <div class="col-9">
        ...
        <button type="submit" class="search-order__button w-100 hvr-glow">TÌM KIẾM ĐƠN HÀNG</button>
    </div>
    <div class="col"></div>
</form>
@endsection